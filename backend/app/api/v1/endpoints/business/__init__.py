...
async def upload_actual_data(
    ...
    mape      = ecle_dict.get("mape")      # from model registry — None if not computed
    rmse      = ecle_dict.get("rmse")      # from model registry — None if not computed
