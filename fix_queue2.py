...
END_AFTER = b'        </aside>\r\n\r\n        {/* \xe2\x94\x80\xe2\x94\x80 CENTER COLUMN'

i_start = raw.find(START)
i_end   = raw.find(END_AFTER, i_start)
...
NEW = (
    ...
    b'        </aside>\r\n'
    b'\r\n'
    b'        {/* \xe2\x94\x80\xe2\x94\x80 CENTER COLUMN'
)

raw = raw[:i_start] + NEW + raw[i_end + len(END_AFTER):]
